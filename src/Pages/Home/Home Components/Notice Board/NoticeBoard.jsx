...
const NoticeBoard = () => {
  const currentDate = showCurrentDate()
    return (
        <div className="max-w-screen-2xl lg:flex  justify-center  mx-auto h-s">
          
          <div data-aos="fade-up"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="1000" className="border-2 overflow-hidden  h-[30%] m-2  lg:w-[40%]">
      ...
      {/* Head title */}
            ...
            <p className="text-white lg:text-xl text-sm pr-2">{currentDate}</p>
            </div>
...
data-aos-duration="2000" className="container p-5">
  <div className="border-l-2 border-blue-600 p-5">
  <h1 className="hover:text-blue-500  text-gray-400     ">Eid ul Adha Notice</h1>
  <p className="text-blue-500">22 May 2024</p>
  </div>
</div>
          ...
          <div data-aos="fade-up"
     data-aos-easing="ease-out-cubic"
     data-aos-duration="1000" className="border-2 h-[40%] m-2  lg:w-[40%]">
            <div className="bg-blue-600 flex items-center justify-between">
            <h1 className="text-center p-2 text-xl flex gap-2 items-center text-white font-bold "> <IoMdNotifications className="lg:text-3xl text-lg text-center" /> Events </h1>
